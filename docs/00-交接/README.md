...
总入口见 [docs/README.md](../README.md)。本目录只记录岗位交接，不承载新的产品或架构裁定。
...
所有继任者先读本目录对应岗位包，再读其原始报告、`D:\Magic\docs\01-产品\\PRD-01-Magic产品总览.md` 与 `D:\Magic\docs\02-架构\02-Magic-目标项目\PRODUCT_TECH_ALIGNMENT_BASELINE.md`。完成后必须明确说明：已读材料、确认的事实、未知项和首个工作计划。
