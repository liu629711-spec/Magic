...
上游产品入口统一见 [docs/README.md](../README.md) 和 [产品文档入口](../01-产品/README.md)。本目录只负责前端现状取证和目标体验设计，不产生新的产品裁定。
...
- `01-OpenCode/`、`03-AgentCore-现有项目/`：现有页面、组件、状态和协议的证据拆解。
- `02-Magic-目标项目/`：目标信息架构、页面、交互和协议需求，均属于待建立设计。
- 报告应放回对应项目目录，明确版本、证据等级、首版范围和待核查项，不与产品正式规格混放。
