设计 token
56 个 token，符合 OpenDesign 的 token 契约——你的 agent 读取的正是这套结构化的配色、字体、间距和动效值，用以为任意产物设定主题。
...
字体排印
--font-display
"Signifier", "Source Serif Pro", Georgia, ui-serif, serif
--font-body
"Söhne", "Inter", system-ui, -apple-system, "Segoe UI", sans-serif
--font-mono
"Söhne Mono", ui-monospace, "JetBrains Mono", Menlo, Consolas, monospace
字号层级
--text-xs
12px
--text-sm
