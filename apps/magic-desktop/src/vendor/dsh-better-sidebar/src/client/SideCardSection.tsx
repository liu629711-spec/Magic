...
// Type-only slot merges（settings.section）在 magic-desktop 无宿主 ui-slots 包，
// PropsRuntime 用宽 Record 代替——注入面仍由 SideCardSectionInjected 保证。
import {
  TITLE_BAR_STRIP_MAX,
  TITLE_BAR_STRIP_MIN,
  type SidebarPrefs,
...
export type SideCardSectionProps = Record<string, unknown> & SideCardSectionInjected
