// vendored from dsh-better-sidebar@0.19.1 src/client/api.ts （Magic 客户端复用；改动处见各注释）
/**
...
import type { LastActivity } from './vendor-types.ts'
import type { SidechatLiveEvent, SidechatLogEvent, SidechatThreadInfo } from './vendor-types.ts'
import type { SidebarSessionEvent } from './vendor-types.ts'
import type { BrowserProbeResult } from './vendor-types.ts'
