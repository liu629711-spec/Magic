// vendored from dsh-better-sidebar@0.19.1 src/client/locales.ts （Magic 客户端复用；改动处见各注释）
/**
...
export const zh = {
  ...
  guideDescSidechat: '从当前会话 fork 的侧边聊天，独立演进不回流主线',
  ...
  // 2026-09-18（3099-sidenote 对齐）：侧聊词汇表改 sidenote 用语——「侧边聊天」
  // （fork 式，从当前会话分叉独立演进），替换 better-sidebar 内建管理页的
  // 「侧边对话(beta)」用语。
  sideChat: '侧边聊天',
  sideChatBeta: '侧边对话',
  sideChatNew: '新建侧边聊天',
  ...
  trajectory: '调用轨迹',
  // Magic（2026-09-20）：计划 tab（PRD-02 §15.4）。
  plan: '计划',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  guideDescSidechat: 'A side chat forked from this session; evolves independently',
  ...
  // Magic (2026-09-20): the plan dock tab (PRD-02 §15.4).
  plan: 'Plan',
