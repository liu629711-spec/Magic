/** Framework-neutral snapshot and store contracts（照抄上游 packages/client/store/src/contract.ts）。 */
...
// （照抄上游 contract.ts 原文，含豁免注释——never[] 会在 strictFunctionTypes
// 下拒绝 stores.ts 的具体 action 签名。）
