// vendored from @deepseek-ai/dsh-client-ui-chat@0.1.5-rc.2 client/conversation-nodes/tool.ts
// （剥离：cordis Context 注册函数与 declare module 合并；
// isAppendSurfaceEvent 来自 vendor-types 本地等价实现。）
...
/** 根 Tool 生命周期与嵌套 PTC dispatch Definition。 */
