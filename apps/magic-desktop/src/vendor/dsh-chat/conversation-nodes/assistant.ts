// vendored from @deepseek-ai/dsh-client-ui-chat@0.1.5-rc.2 client/conversation-nodes/assistant.ts
// （剥离：cordis Context 注册函数 registerAssistantConversationNode、
// ConversationStepDataMap 的 declare module 合并（本地 Location data phase 显式
// 以 kind 'assistant-step' 发布）。折叠逻辑零改动。）
...
/** 每步 Assistant 流式/落定/中断 Definition。 */
