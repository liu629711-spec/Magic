// vendored from @deepseek-ai/dsh-client-ui-chat@0.1.5-rc.2 client/conversation-nodes/turn-tail.ts
// （剥离：cordis Context 注册函数与 declare module 合并；
// deriveTurnTokenUsage 由本地等价实现 conversation-nodes/token-usage.ts 供应。）

import type {
  ConversationMatch, ConversationNodeContext, ConversationNodeDefinition, TurnLocation,
} from '../vendor-types.ts'
import type { StreamChunk, SessionEvent } from '../vendor-types.ts'
import type {
...
import { deriveTurnTokenUsage } from './token-usage.ts'
...
/** 与任何 Assistant 行独立的完成轮页脚 Definition。 */
