// vendored from @deepseek-ai/dsh-client-ui-tool@0.1.5-rc.2 client/tool/models/web-card-model.ts
...
/** presenter 拥有的 web 卡片数据；渲染点补充本地化标签与 class。 */
...
/** 从持久元数据推导落定的根 web-search 或 web-fetch 卡片。 */
