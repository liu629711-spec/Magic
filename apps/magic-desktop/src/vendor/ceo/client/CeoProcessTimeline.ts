// 搬自 plugins/magic-ceo-ui/src/client/CeoProcessTimeline.ts（2026-09-18 CEO 委派图卡右坞成员详情接入）。
// 原样保留：成员过程时间线（思考/工具/搜索/抓页明细 + 折叠摘要行）。
// import 路径同源本地化：../team.ts、../process-summary.ts、../processView.ts、./theme.ts。
// 文案 t 由调用方注入（右坞用 ./dict.ts 的 ceoT）。
